import { ReactComponent as CpuChip } from './cpu-chip.svg?react';
import { ReactComponent as DocumentClipboard } from './document-clipboard.svg?react';
import { ReactComponent as XCircleIcon } from './x-circle.svg?react';
import { ReactComponent as WindowIcon } from './window.svg?react'
...
import { ReactComponent as AdjustmentIcon } from './adjustments.svg?react';
import { ReactComponent as LoadIcon } from './load.svg?react';
import { ReactComponent as WranchIcon } from './wranch.svg?react';
import { ReactComponent as TerminalIcon } from './terminal.svg?react';
